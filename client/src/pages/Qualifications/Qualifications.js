  ...
  return (
    ...
    <div className="card mt-5">
      <div className="card-body">
          <h3 className='CompetitionTopics'>คุณสมบัติผู้สมัคร</h3>
          <Table>
          <tbody>
            ...
            <tr className='column1'>
              <td style={{color:'red'}}>- ระดับนักเรียน: ประถมศึกษา มัธยมศึกษา อาชีวศึกษา หรือเทียบเท่า (ปวช.)</td>
            </tr>
            <tr className='column1'>
              <td style={{color:'red'}}>- ระดับนิสิตและนักศึกษา: อาชีวศึกษา หรือเทียบเท่า (ปวส.) และอุดมศึกษา (ไม่เกินปริญญาตรี)</td>
            </tr>
